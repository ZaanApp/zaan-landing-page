      ...
      <div className="container mx-auto max-w-5xl">
        <div className="flex flex-col items-center text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Take Control of Your Salon's Finances?
          </h2>
          <p className="text-xl max-w-3xl mb-10">
            Join thousands of salon owners who are making data-driven decisions
            with Zaan's powerful financial reporting tools. Start your free
            trial today and see the difference for yourself.
          </p>
